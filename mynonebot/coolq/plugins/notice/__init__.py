...
from nonebot.coolq.db.model.notice import has_signed_today, sign as sign_to_db
from coolq.util.coolq import at_someone
from mynonebot.config import NEED_SIGN_USER
...
@nonebot.scheduler.scheduled_job('cron', hour="21", minute="0-59/5")
